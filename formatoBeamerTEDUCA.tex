...
\newcommand{\fondo}[1]{
    % Selecciona el fondo
    \setbeamertemplate{background}{\includegraphics[width=\paperwidth]{FondoTEDUCA/#1}}
...
\usecolortheme{orchid}
    ...
    \setbeamercolor{author}{fg=celeste,bg=}
    \setbeamerfont{author}{series=\bfseries}
    \setbeamercolor{date}{fg=celeste,bg=}
    \setbeamerfont{date}{series=\bfseries}
    \setbeamercolor{institute}{fg=celeste,bg=}
...
\setbeamertemplate{frametitle}{%
  % Mueva el bloque del título hacia arriba:
  \vspace*{-10mm}% ajuste este valor: -4mm, -8mm, etc.
  \nointerlineskip
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.5ex,dp=1.5ex,leftskip=1em]{frametitle}%
    \usebeamerfont{frametitle}\hspace*{2mm}\insertframetitle
  \end{beamercolorbox}%
}
\makeatother
...
\setbeamertemplate{title page}{%
  % Ajuste este espacio para bajar el título
  \vspace*{53mm} % mayor valor = más abajo

  \begin{beamercolorbox}[wd=0.75\textwidth,leftskip=-3em,bg=]{title}
    {\usebeamerfont{title}\inserttitle\par}
  \end{beamercolorbox}

  \vspace{1mm}

  \begin{beamercolorbox}[wd=0.75\textwidth,leftskip=-3em]{author}
    {\usebeamerfont{author}\insertauthor\par}
  \end{beamercolorbox}

  \vspace{-1mm}

  \begin{beamercolorbox}[wd=0.75\textwidth,leftskip=-3em]{institute}
